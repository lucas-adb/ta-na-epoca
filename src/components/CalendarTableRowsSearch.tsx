...
export default async function CalendarTableRowsSearch({
  ...
  const rows = await getFoodWithMonthsFiltered({ food, type, month });
...
//   selectedType,
//   selectedMonth,
// }: { foodName: string; selectedType: "FRUIT" | "VEGETABLE"; selectedMonth: string
// }): Promise<JSX.Element> {
//   const rows = await getFoodWithMonthsFiltered({ type: selectedType });
